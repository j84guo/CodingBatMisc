public class CodingBat{
	...
	public int countHi2Api(String str) {
	   ...
	   if(str.startsWith("xhi"))
		  return countHi2Api(str.substring(3));
	   if(str.startsWith("hi"))
		  return 1+countHi2Api(str.substring(2));
	   
	   return countHi2Api(str.substring(1));
	}
	...
	public static void main(String[] args){
		...
		System.out.println(cb.strDist("catcowdogcatdog", "cat"));
	}
}
